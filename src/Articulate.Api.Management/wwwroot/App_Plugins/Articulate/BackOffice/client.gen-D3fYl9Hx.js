const w = (s, t, e) => {
  ...
  const e = { ...s, ...t };
  return e.baseUrl?.endsWith("/") && (e.baseUrl = e.baseUrl.substring(0, e.baseUrl.length - 1)), e.headers = q(s.headers, t.headers), e;
}, q = (...s) => {
  const t = new Headers();
  for (const e of s) {
...
//# sourceMappingURL=client.gen-D3fYl9Hx.js.map
