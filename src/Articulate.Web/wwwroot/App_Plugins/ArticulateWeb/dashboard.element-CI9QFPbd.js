import { LitElement as g, html as b, css as x, state as m, customElement as W } from "@umbraco-cms/backoffice/external/lit";
...
import { c } from "./client.gen-DFzeT1VX.js";
class p {
  static ping(e) {
    return ((e == null ? void 0 : e.client) ?? c).get({
      ...
      url: "/umbraco/articulateweb/api/v1/ping",
      ...e
    });
  }
  static whatsMyName(e) {
    return ((e == null ? void 0 : e.client) ?? c).get({
      ...
      url: "/umbraco/articulateweb/api/v1/whatsMyName",
      ...e
    });
  }
  static whatsTheTimeMrWolf(e) {
    return ((e == null ? void 0 : e.client) ?? c).get({
      ...
      url: "/umbraco/articulateweb/api/v1/whatsTheTimeMrWolf",
      ...e
    });
  }
  static whoAmI(e) {
    return ((e == null ? void 0 : e.client) ?? c).get({
      ...
      url: "/umbraco/articulateweb/api/v1/whoAmI",
      ...e
    });
  }
}
...
}, w = (t, e, r) => e.has(t) || y("Cannot " + r), u = (t, e, r) => (w(t, e, "read from private field"), r ? r.call(t) : e.get(t)), h = (t, e, r) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), N = (t, e, r, a) => (w(t, e, "write to private field"), e.set(t, r), r), n, v, f, _;
let s = class extends T(g) {
  constructor() {
...
//# sourceMappingURL=dashboard.element-CI9QFPbd.js.map
