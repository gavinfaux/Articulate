...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Articulate.Web")]
    public class ArticulateWebApiController : ArticulateWebApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public ArticulateWebApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
