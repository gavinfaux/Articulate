...
namespace Articulate.Web.Composers
{
    public class ArticulateWebApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Articulate Web Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<ArticulateWebOperationSecurityFilter>();
            });
        }

        public class ArticulateWebOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Articulate.Web.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
