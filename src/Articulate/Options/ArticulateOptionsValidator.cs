...
//            if (options is { AutoGenerateExcerpt: true, GenerateExcerpt: null })
//            {
//                errors.Add("Articulate: GenerateExcerpt delegate must not be null when AutoGenerateExcerpt = true");
//            }

//            if (options.AllowedImageExtensions.Contains())
//            {
