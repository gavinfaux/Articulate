...
public static class PublishedContentExtensions
{
    ...
    public static IHtmlContent ListTags(this PostModel model, Func<string, HelperResult> tagLink, string delimiter = ", ") => PublishedContentExtensions.ListCategoriesOrTags(model.Tags.ToArray(), tagLink, delimiter);

    public static IHtmlContent ListCategories(this PostModel model, Func<string, HelperResult> tagLink, string delimiter = ", ") => PublishedContentExtensions.ListCategoriesOrTags(model.Categories.ToArray(), tagLink, delimiter);
