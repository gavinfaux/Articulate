...
public sealed class ArticulatePlan : MigrationPlan
{
    ...
    private void DefinePlan()
    {
        From(InitialState)
            ...
            .To<V_6_0_1.MigrateArticulateRichTextTiptapConfiguration>(new Guid("F1782FD1-52DE-4A41-99E8-99974BB274FE"))
            .To<V_6_0_1.OrganizeArticulatePostProperties>(new Guid("D2B0C0A4-5F7A-4E1C-9A8B-6D4F2A1E7C93"));
    }
}
