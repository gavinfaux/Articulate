...
namespace Articulate.Components
{
     ...
     *   /App_Plugins/Articulate/
       ...
       |   |-- ... etc ...
       |-- Views/                          <-- Non-theme-related views.
       |   |-- _ViewImports.cshtml         <-- OPTIONAL: Adds specific @using statements or tag helpers
    ...
    public class ArticulateThemeViewLocationExpander(IArticulateThemeService themeService) : IViewLocationExpander
    {
