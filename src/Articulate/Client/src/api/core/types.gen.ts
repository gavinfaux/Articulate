...
export type PostPublishedCacheCollectData = {
    body?: never;
    path?: never;
    query?: never;
...
export type PostPublishedCacheCollectErrors = {
    /**
     * The resource is protected and requires an authentication token
     */
    401: unknown;
...
export type GetPublishedCacheStatusData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetPublishedCacheStatusErrors = {
    /**
     * The resource is protected and requires an authentication token
     */
    401: unknown;
