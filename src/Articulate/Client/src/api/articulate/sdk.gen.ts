...
export class Articulate {
     ...
     */
    public static getUmbracoManagementApiV1ArticulateBlogArticulateGuid<ThrowOnError extends boolean = false>(options?: Options<GetUmbracoManagementApiV1ArticulateBlogArticulateGuidData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<GetUmbracoManagementApiV1ArticulateBlogArticulateGuidResponses, GetUmbracoManagementApiV1ArticulateBlogArticulateGuidErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     */
    public static getUmbracoManagementApiV1ArticulateThemesDefault<ThrowOnError extends boolean = false>(options?: Options<GetUmbracoManagementApiV1ArticulateThemesDefaultData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<GetUmbracoManagementApiV1ArticulateThemesDefaultResponses, GetUmbracoManagementApiV1ArticulateThemesDefaultErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
