...
export type GetArticulateThemesAllData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetArticulateThemesAllErrors = {
    /**
     * The resource is protected and requires an authentication token
     */
    401: unknown;
...
export type GetArticulateThemesAllResponses = {
    /**
...
export type GetArticulateThemesAllResponse = GetArticulateThemesAllResponses[keyof GetArticulateThemesAllResponses];
