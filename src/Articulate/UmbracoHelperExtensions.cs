...
namespace Articulate
{
    public static class UmbracoHelperExtensions
    {
        ...
        [Obsolete(
            "Use GetRecentPosts(this UmbracoHelper helper, IMasterModel masterModel, int count, IPublishedValueFallback publishedValueFallback)")]
        public static IEnumerable<PostModel> GetRecentPosts(
            ...
            helper.GetRecentPosts(masterModel, count, publishedValueFallback);
        ...
        [Obsolete(
            "Use GetRecentPosts(this UmbracoHelper helper, IMasterModel masterModel, int page, int pageSize, IPublishedValueFallback publishedValueFallback)")]
        public static IEnumerable<PostModel> GetRecentPosts(
            this UmbracoHelper helper,
            IMasterModel masterModel,
            int page,
            ...
            IPublishedValueFallback publishedValueFallback,
            IVariationContextAccessor variationContextAccessor) =>
            helper.GetRecentPosts(masterModel, page, pageSize, publishedValueFallback);
        ...
        [Obsolete(
            "Use GetRecentPostsByArchive(this UmbracoHelper helper, IMasterModel masterModel, int page, int pageSize, IPublishedValueFallback publishedValueFallback)")]
        public static IEnumerable<PostModel> GetRecentPostsByArchive(
            ...
            IPublishedValueFallback publishedValueFallback,
            IVariationContextAccessor variationContextAccessor) =>
            helper.GetRecentPostsByArchive(masterModel, page, pageSize, publishedValueFallback);
        ...
        private static IPublishedContent[] GetListNodes(IMasterModel masterModel) =>
            PublishedContentExtensions.GetListNodes(masterModel);
    }
}
