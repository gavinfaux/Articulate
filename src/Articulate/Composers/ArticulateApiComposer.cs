// TODO: Replaced with APIVersioning / OpenAPI - https://docs.umbraco.com/umbraco-cms/reference/api-versioning-and-openapi
...
//namespace Articulate.Composers
//{
...
//                {
//                    Title = "Articulate Backoffice API",
//                    Version = "1.0",
...
//                opt.OperationFilter<ArticulateOperationSecurityFilter>();
//            });
//        }
...
//            {
//                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Articulate.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
//            }
